        ...
        "properties": {
            "drift_level": {
                ...
                "description": (
                    ...
                    "CATEGORY of information being collected. A/B test funnels routinely add, remove, "
            ...
            "alert_worthy_changes": {
                ...
                "description": (
                    ...
                    "collected that was never asked before in any form. "
                    "Questions about the same topic areas "
...
def _build_eval_prompt(
    ...
    return (
        ...
        "asked about before in any form\n\n"
        "## Your task\n"
