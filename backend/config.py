...
# Stagehand-flavoured LLM config. The traversal driver reads LLM_PROVIDER /
# LLM_MODEL directly; we keep a helper here for anyone who wants the
# provider-qualified model name as a single string.
def stagehand_model_name() -> str:
